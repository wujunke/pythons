...
def savetocsvfile(data):
    with open("test3.csv","a") as csvfile:
        ...
        writer.writerow([
            ...
            data['top'],
            data['investor'],
            int(data['invse_detail_money']) if int(data['invse_detail_money']) < int(data['invse_total_money']) else int(data['invse_total_money']),
